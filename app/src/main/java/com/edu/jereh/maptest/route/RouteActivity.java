package com.edu.jereh.maptest.route;
...
private LatLonPoint mEndPoint;
	...
	protected void onCreate(Bundle bundle) {
		...
		nlatitude=intent.getExtras().getDouble("nlatitude");
		nlongitude=intent.getExtras().getDouble("nlongitude");
		 mStartPoint=new LatLonPoint(latitude,longitude);
		mEndPoint=new LatLonPoint(nlatitude,nlongitude);
