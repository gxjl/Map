package com.edu.jereh.maptest.util;

import com.amap.api.maps.model.LatLng;

/**
 * Created by 11466 on 2016/11/19.
 */
...
public class Constants {
    ...
    public static final LatLng YANTAI = new LatLng(37.52, 121.39);// 烟台市经纬度
    public static final LatLng MUPING = new LatLng(37.38, 121.59);// 牟平区经纬度
    public static final LatLng ZHIFU = new LatLng(37.30, 121.49);// 芝罘区经纬度
    public static final LatLng FUSHAN = new LatLng(37.40, 121.39);// 福山区经纬度
}
